   ...
   <?php include_once "nav.php"; ?>
    ...
    <div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Why Us</h1>
            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 feature-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 ps-lg-0">
                        ...
                        <p class="mb-4 pb-2">In considering our services, several distinctive attributes set us apart and make us the optimal choice. First and foremost, our unwavering commitment to excellence defines our approach. We consistently deliver unparalleled quality, ensuring that our clients receive nothing short of the finest solutions.
...
In choosing us, you are selecting a partner dedicated to your success, armed with a proven track record, a wealth of expertise, and an unwavering commitment to excellence. We invite you to experience the unparalleled value that sets us apart in the realm of exceptional service provision.</p>
                        <div class="row g-4">
                            <div class="col-6">
                ...
                <div class="col-lg-6 pe-lg-0" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute img-fluid w-100 h-100" src="img/scripture1.jpg" style="object-fit: cover;" alt="">
                    </div>
                </div>
            </div>
        </div>
