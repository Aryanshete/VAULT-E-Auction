    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="section-title text-center">
                <h1 class="display-5 mb-5" style="color: rgb(215, 152, 75);">Indulge Yourself Into The Thrill Of Auction</h1>
            </div>
            ...
            <div class="row g-4 portfolio-container">
                <?php 
$query = "SELECT * FROM auctions WHERE end_time > NOW() ORDER BY id DESC";
                ...
                <div class="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.1s">
                    <div class="rounded overflow-hidden">
                        ...
                        <img class="img-fluid w-100" src="img/auctions/<?=$row['image'];?>" alt="">
                            <div class="portfolio-overlay">
                            <a class="btn btn-square btn-outline-light mx-1" href="img/auctions/<?=$row['image'];?>"
 data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                                <a class="btn btn-square btn-outline-light mx-1" href="bid.php?id=<?=$row['id'];?>"><i class="fa fa-link"></i></a>
                            </div>
                        </div>
                        <div class="border border-5 border-light border-top-0 p-4">
                            <p class="text-primary fw-medium mb-2"><a href="bid.php?id=<?=$row['id'];?>"><?=$row['title'];?></a></p>
